...
1. Add your API method to `src/main/java/com/softwareproviders/fanikiwa/YourFirstAPI.java`.

1. Optional step: These sub steps are not required but you need this
   if you want to have auth protected methods.

    1. Update the values in `src/main/java/com/softwareproviders/fanikiwa/Constants.java`
...
# fanikiwa
fanikiwa
>>>>>>> branch 'master' of https://github.com/kevinmutugi/fanikiwa.git
